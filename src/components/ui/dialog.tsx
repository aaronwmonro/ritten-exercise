...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    ...
    /** "bottom" = slide from bottom; default = slide from center */
    animation?: "default" | "bottom";
  }
>(
  (
    {
    ...
    const animationClasses =
      animation === "bottom"
        ? "data-[state=open]:slide-in-from-bottom data-[state=open]:slide-in-from-left-0 data-[state=open]:fade-in-100 data-[state=closed]:slide-out-to-bottom data-[state=closed]:slide-out-to-left-0 data-[state=closed]:fade-out-100 data-[state=open]:zoom-in-100 data-[state=closed]:zoom-out-100"
